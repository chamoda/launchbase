...
import { useGetCurrentAdminUser } from "@/api/endpoints/users/users";
import { PUBLIC_ROUTES } from "@/lib/routes";

// Resolves the current session from GET /users/self (authenticated via the
// httponly admin_access_token cookie) and redirects to /login when a protected
