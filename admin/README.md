...
The Launchbase admin console — a [TanStack Start](https://tanstack.com/start)
single-page app. It talks to the API's `/admin` surface (admin-audience
tokens, `admin_access_token` cookie) and provides user management for
administrators.
